# tremor Theme for Hugo

This theme derives from the awesome Kube hugo theme (https://imperavi.com/kube/).
...
This theme is licensed under the same license as the original theme from which it is derived - the MIT license.
